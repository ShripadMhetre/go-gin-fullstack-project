...
import (
	...
	"github.com/shripadmhetre/go-gin-fullstack-project/database"
	helper "github.com/shripadmhetre/go-gin-fullstack-project/helpers"
	"github.com/shripadmhetre/go-gin-fullstack-project/models"
...
func Signup() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		if count > 0 {
			c.JSON(http.StatusBadRequest, gin.H{"error": "This Email ID already exists!"})
			return
		}
